        ...
        <div class="priview-header">
            <?php foreach ($appealOrderLists as $key => $row) { ?>
                <div class="contentForm" style="font-size: medium;">
                    <?php if ($key == 0) { ?>
                        <div id="head">
                            <?php echo nl2br(str_replace("&nbsp;", " ", $row->order_header)); ?>
                        </div>
                    <?php } ?>
                <?php } ?>
                </div>
                ...
                <div class="priview-demand">
                    <table class="table table-hover table-bordered report">
                        <thead class="headding">
                            <tr>
                                <th class="text-center" width="50">আদেশের ক্রমিক নং</th>
                                <th class="text-left">তারিখ</th>
                                <th class="text-right">আদেশ</th>
                                <th class="text-right">স্বাক্ষর</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($appealOrderLists as $key => $row) { ?>
