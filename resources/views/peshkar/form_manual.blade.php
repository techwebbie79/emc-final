...
@section('content')
        ...
        <div class="card card-custom col-12">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('peshkar.adm.dm.list') }}" class="btn btn-sm btn-primary font-weight-bolder">
                        <i class="la la-list"></i> পেশকার তালিকা
                    </a>
                </div>
            </div>
            ...
            <form action="{{ route('peshkar.create.manual.form.submit') }}" method="POST" enctype="multipart/form-data"
                id="peshkar_form_manaul">
                @php
    ...
    <!--end::Card-->
    @include('peshkar.inc._form_validation');
@endsection
