                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <!--begin::Action-->
                                        <div class="pb-lg-0 pb-5">
                                            <button class="text-center btn btn-primary btn-block font-size-h6 px-8 py-4 my-3 mr-3"
                                                wait-class="spinner spinner-right spinner-white pr-15 "><i class="fab fa-facebook-f"></i> Facebook</button>
                                        </div>
                                    </div>
                                    <div class="col-md-4"></div>
                                    <div class="col-md-8">
                                ...
                                <div class="col-md-12 text-center">
                                    <span class="text-center text-danger">*মাইগভের মাধ্যমে লগইন করতে চাইলে CADP এ ক্লিক করুন*</span>
                                </div>
                            </div>
                            <br>
