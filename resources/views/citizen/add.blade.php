                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 mb-5">
                                        ...
                                        <input type="text" name="name" id="name"
                                            class="form-control form-control-sm" value="{{ $results->name_bn }}" readonly>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <label> পিতার নাম <span class="text-danger">*</span></label>
                                        <input type="text" name="father" id="name"
                                            class="form-control form-control-sm" value="{{ $results->father }}" readonly>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <label> মাতার নাম <span class="text-danger">*</span></label>
                                        <input type="text" name="mother" id="name"
                                            class="form-control form-control-sm" value="{{ $results->mother }}" readonly>
                                    </div>
                                    <div class="col-lg-6 mb-5">
                                        <label>জন্ম তারিখ <span class="text-danger">*</span></label>
                                        <input type="date" name="dob" id="dob"
                                            class="form-control form-control-sm" value="{{ $results->dob }}" readonly>
                                    </div>
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <select name="citizen_gender" id="citizen_gender"
                                            ...
                                            <option value="MALE"
                                                {{ $results->gender == 'MALE' ? 'selected' : 'disabled' }}>পুরুষ
                                            </option>
                                            <option value="FEMALE"
                                                {{ $results->gender == 'FEMALE' ? 'selected' : 'disabled' }}>নারী
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <input type="text" name="mobile_no" id="mobile_no"
                                            ...
                                            placeholder="মোবাইল নম্বর , ইংরেজিতে লিখুন " autocomplete="off" required
                                            value={{ old('mobile_no') }}>
