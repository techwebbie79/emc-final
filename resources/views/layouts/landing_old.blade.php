...
<body onload="" id="kt_body" class="header-fixed header-mobile-fixed aside-fixed aside-minimize-hoverable page-loading">
    <div class="" onload="pagePreLoaderOff()" id="pagePreLoader"></div>
    {{-- @include('layouts.landing._header_mobile') --}}
    @include('layouts.landing._header_mobile_old')
