...
@section('content')
    ...
    <div class="row">
        <div class="card card-custom col-12">
            ...
            <form action="{{ route('user-management.update', ['id'=>$userManagement->id]) }}" method="POST"
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="username" class=" form-control-label">ইউজারনেম <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="username" name="username" placeholder="ব্যবহারকারীর নাম লিখুন"
                                        class="form-control form-control-sm" value="{{ $userManagement->username }}"
                                        readonly="readonly">
                                    <span style="color: red">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select name="office_id" id="office_id" class="form-control-sm form-control">
                                        ...
                                        @if ($value->is_dm_adm_em==1)
                                            <option value="{{ $value->id }}" {{ $value->id == $userManagement->office_id ? 'selected' : '' }}> {{ $value->office_name_bn }},
                                                {{ $value->upazila_name_bn }} {{ $value->district_name_bn }}
                                            </option>
                                        @endif
                                    @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="court_id" id="court_id" class="form-control-sm form-control">
                                        ...
                                        @foreach ($courts as $value)
                                            <option value="{{ $value->id }}" {{ $value->id == $userManagement->court_id ? 'selected' : '' }}> {{ $value->court_name }}, {{ $value->district_name_bn }}
                                            </option>
                                    @endforeach
                                    </select>
                                    <span style="color: red">
