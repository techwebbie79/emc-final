         ...
         <thead class="thead-light ">
            <tr>
              ...
              <!--  <th scope="col">স্ট্যাটাস</th> -->
               <th scope="col" width="15%">পদক্ষেপ</th>
            </tr>
         </thead>
         <tbody>
            ...
            <tr>
               ...
               <td>{{ $row->username }}</td>
               <td>{{ $row->role_name }}</td>
               <td>{{ $row->court_name }}, {{ $row->district_name_bn }}</td>
               <td>{{ $row->email }}</td>
               <!-- <td>
                  <span class="label label-inline label-light-primary font-weight-bold">Pending</span>
               </td> -->
               <td>
                  <a href="/user-management/show/{{$row->id}}" class="btn btn-primary btn-shadow btn-sm font-weight-bold pt-1 pb-1">বিস্তারিত</a>
                  {{-- <a href="/user-management/edit/{{$row->id}}" class="btn btn-success btn-shadow btn-sm font-weight-bold pt-1 pb-1">সংশোধন</a> --}}
                </a>
               </td>
            </tr>
            @endforeach
