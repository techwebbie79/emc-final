...
<div role="tabpanel" aria-labelledby="regTab8" class="tab-pane fade" id="regTab_8">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                   ...
                                   <div class="input-group-prepend"><span class="input-group-text">+8801</span></div>
                                    ...
                                    <input id="defaulerLawyerphn_1" name="defaulerLawyer[phn][]"
                                        class="form-control form-control-sm "
                      ...
                      @endphp --}}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label"> <span style="color:#FF0000"></span>প্রাতিষ্ঠানিক
                                        আইডি </label>
                                    <input id="defaulerLawyerorganization_id_1" name="defaulerLawyer[organization_id][]" class="form-control form-control-sm"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="defaulerLawyerdesignation_1" name="defaulerLawyer[designation][]" class="form-control form-control-sm"
                                        value="{{ $designation ?? '' }}"
                                        {{ $readonly }}>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label"><span style="color:#FF0000"></span>প্রতিষ্ঠানের
                                        নাম</label>
                                    <input id="defaulerLawyerorganization_1" name="defaulerLawyer[organization][]" class="form-control form-control-sm"
                                        value="{{ $organization ?? '' }}"
                                        {{ $readonly }}>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>ইমেইল</label>
                                    <input type="email" id="defaulerLawyeremail_1" name="defaulerLawyer[email][]"
                                        class="form-control form-control-sm"
