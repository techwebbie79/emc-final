<div class="form-group">
    <div class="row">
        <div class="col-md-12">
            ...
            @endphp
            <div class="form-group">
                <h4 class="bg-gray-300 card-title h4 py-3 text-center">{{ $em_text }} শেষ আদেশ, {{ en2bn($em_last_order['order_date_em'] ?? '') }}</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="bg-gray-100 rounded-md rounded-right-0">
                                    <div class="p-4 h5">
                                        {!! nl2br($em_last_order['em_order'] ?? '') !!}</div>
                                </div>
                            </div>
                        </div>
                        @if(!empty($em_last_order['em_files']))
                        <div class="row">
                            <fieldset class="col-md-12 border-0 bg-white">
                                @forelse (json_decode($em_last_order['em_files'],true) as $key => $row)
