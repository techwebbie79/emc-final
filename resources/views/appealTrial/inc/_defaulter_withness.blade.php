<div role="tabpanel" aria-labelledby="regTab7" class="tab-pane fade" id="defaulerWithnessCitizen">
                        ...
                        <div id="cloneNomenee" class="card">
                            <div class="card-header" id="headingOne3">
                                <div class="card-title h4 {{ $count == 1 ? '' : 'collapsed' }}" data-toggle="collapse"
                                    ...
                                    বিবাদী পক্ষের সাক্ষীর তথ্য &nbsp; <span id="spannCount">({{ $count }})</span>
                                </div>
                            </div>
                        ...
                        <div id="cloneNomenee" class="card">
                            ...
                            <div class="card-header" id="headingOne3">
                                <div class="card-title h4" data-toggle="collapse" data-target="#collapseOne3">
                                    বিবাদী পক্ষের সাক্ষীর তথ্য &nbsp; <span id="spannCount">(1)</span>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input required type="text" {{-- id="applicantCiNID_1" --}}
                                                        ...
                                                        data-defaulerwithnessrowindex='1'
                                                        placeholder="উদাহরণ- 19825624603112948"
                                                        id="defaulerWithness_nid_input_1"
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input required type="text"
                                                            id="defaulerWithness_dob_input_1"
                                                            placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী) বছর/মাস/তারিখ"
                                                            {{-- id="dob" --}}
                                                            class="form-control common_datepicker_1"
                                                            autocomplete="off" data-defaulerwithnessrowindex='0'>

                                                        <input type="button" id="defaulerWithness_nid_1"
                                                            data-defaulerwithnessrowindex='1'
                                                            class="btn btn-primary check_nid_button"
                                                            onclick="NIDCHECKdefaulerWithness(this.id)"
                                                            value="সন্ধান করুন">
                                                    </div>
                                                </div>
                                            </div>
