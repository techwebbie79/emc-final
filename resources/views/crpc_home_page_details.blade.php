...
@section('landing')
    ...
    <style>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 phomebuttons" style="margin-bottom:50px ">

                    <div class="card " style="background: #f4f7f8 !important">
                        <div class="card-body ">
                            <div class="row">
                                @foreach($crpc as $value)
                                <div class="my-5 py-5 p-class-ornament">

                                    <h3>{{ $value->crpc_name  }}, ধারা নং {{ en2bn($value->crpc_id) }}</h3>
                                    <p style="text-align: justify">{{ $value->crpc_details  }}</p>
                                </div>
