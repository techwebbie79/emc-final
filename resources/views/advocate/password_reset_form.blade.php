                    ...
                    <div class="card " style="background: #f6f6f7 !important">
                        <div class="card-body mt-15">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <button class="btn btn-success btn-block"><i class="fas fa-users"></i> পাসওয়ার্ড রিসেট নিবন্ধন</button>
                                </div>
                            </div>
                            <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nid_no" id="nid_no" class="form-control form-control name-group" placeholder="উদাহরণ- 19825624603112948">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="mobile_number" id="nid_no" class="form-control form-control name-group" placeholder="+8801xxxxxxx">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="dob"
                                                ...
                                                <input type="text" name="username" id="username" class="form-control form-control name-group" >
