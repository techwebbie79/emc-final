                        ...
                        <div class="card-body mt-15">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                        ...
                                        border-color: #008841;
                                        border-radius:5px
                                        "><i class="fas fa-users" style="color: #fff;"></i> আইনজীবী  নিবন্ধন</h4>
                                    </div> 
                                
                            </div>
                            <br>
                            <form id="nidVerifyForm" action="{{ route('advocate.nid_verify') }}" class="form" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="dob"
                                                ...
                                                <input type="text" name="dob" id="dob" class="form-control  common_datepicker" placeholder="বছর/মাস/দিন" autocomplete="off" value="{{ old('dob') }}">
