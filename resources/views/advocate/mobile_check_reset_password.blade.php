                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-8 ">
                                        <div class="form-group row r">
                                            ...
                                            <div class="col-md-2"></div>
                                            <div class="col-md-2"><input type="number" name="otp_1" id="otp_1" class="form-control form-control code" placeholder="0" minlength="1" maxlength="1" required></div>
                                            <div class="col-md-2"><input type="number" name="otp_2" id="otp_2" class="form-control form-control code" placeholder="0" minlength="1" maxlength="1" required></div>
                                            <div class="col-md-2"><input type="number" name="otp_3" id="otp_3" class="form-control form-control code" placeholder="0" minlength="1" maxlength="1" required></div>
                                            <div class="col-md-2"><input type="number" name="otp_4" id="otp_4" class="form-control form-control code" placeholder="0" minlength="1" maxlength="1" required></div>
                                        </div>
                                        <div class="col-md-12 text-center">        
                                            <a href=""><span class="text-center text-success"><b style="font-size: 20px;">এখনও ওটিপি আসে নাই?</b></span></a>
                                        </div>
                                        <div class="col-md-12 text-center ">        
                                            <a href=""><span class="text-center text-danger"><b style="font-size: 20px;">পুনরায় চেষ্টা করুন</b></span></a>
                                        </div>
                                    </div>        
                                </div>
