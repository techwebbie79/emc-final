    ...
    <div class="row">
        ...
        <div class="col-md-12" style="margin-top: 85px">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <h2 class="p-2 text-center" style="color: #fff;
                                        background-color: #008841;
                                        border-color: #008841;
                                        border-radius:5px
                                        "><i class="fas fa-users" style="color: #fff;"></i> প্রোফাইল </h2>
                <form action="{{ route('advocateRegister.store') }}" class="form" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12 mb-5">
                                    ...
                                    <input type="text" name="father" id="name" class="form-control form-control-sm"
                                        value="{{ $results->father  }}" readonly>
                                </div>
                                <div class="col-lg-12 mb-5">
                                    <label> মাতার নাম <span class="text-danger">*</span></label>
                                    <input type="text" name="mother" id="name" class="form-control form-control-sm"
                                        value="{{ $results->mother  }}" readonly>
                                </div>
                                ...
                                <div class="col-lg-6 mb-5">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no"
                                        class="form-control form-control-sm" placeholder="মোবাইল নম্বর , ইংরেজিতে লিখুন " autocomplete="off" required value={{ old('mobile_no') }}>
                                ...
                                <div class="col-lg-6 mb-5form-group">
                                    ...
                                    <div class="input-group" id="show_hide_password_advocate_reg">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#show_hide_password_advocate_reg a").on('click', function(event) {
            event.preventDefault();
            if ($('#show_hide_password_advocate_reg input').attr("type") == "text") {
                $('#show_hide_password_advocate_reg input').attr('type', 'password');
                $('#show_hide_password_advocate_reg i').addClass("fa-eye-slash");
                $('#show_hide_password_advocate_reg i').removeClass("fa-eye");
            } else if ($('#show_hide_password_advocate_reg input').attr("type") == "password") {
                $('#show_hide_password_advocate_reg input').attr('type', 'text');
                $('#show_hide_password_advocate_reg i').removeClass("fa-eye-slash");
                $('#show_hide_password_advocate_reg i').addClass("fa-eye");
            }
        });
