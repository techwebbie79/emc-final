        ...
        <div class="container">
            ...
            <div class="text-center mb-17">
                ...
                <div class="fs-5 h5 fw-bold">গণপ্রজাতন্ত্রী বাংলাদেশ সরকারের এক্সিকিউটিভ ম্যাজিস্ট্রেট কোর্ট ব্যবস্থার অনলাইন প্ল্যাটফর্মে
                    আপনাকে
                    স্বাগতম।
                    সিস্টেমটির মাধ্যমে আবেদনকারী সার্টিফিকেট অভিযোগ দায়ের  করতে পারবে, আপীল করতে পারবে এবং আপীলের
                            ...
                            <div class="d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="h2 text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">
                                        আপিল আবেদন</a>
                                    <div class="h6 text-dark-75">সিস্টেমটির মাধ্যমে আবেদনকারী এক্সিকিউটিভ ম্যাজিস্ট্রেটের নিকট অভিযোগ দায়ের  করতে
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="h6 text-dark-75">সিস্টেমটির মাধ্যমে আবেদনকারী সার্টিফিকেট অভিযোগ দায়ের  করতে
                                        পারবে, আপীল করতে পারবে এবং আপীলের সর্বশেষ অবস্থা সম্পর্কে জানতে পারবে।</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-custom wave wave-animate wave-info mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="h2 text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">
                                        সার্টিফিকেট কোর্ট সম্পর্কিত প্রশ্নোত্তর
                                    </a>
                                    <div class="h6 text-dark-75">সার্টিফিকেট কোর্ট সম্পর্কিত প্রশ্নোত্তর সার্টিফিকেট কোর্ট
                                        সম্পর্কিত প্রশ্নোত্তরসার্টিফিকেট</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-custom wave wave-animate wave-info mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="h2 text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">
                                        সরকারী দাবী আদায় আইন, ১৯১৩
                                    </a>
                                    <div class="h6 text-dark-75">সরকারী দাবী আদায় আইন, ১৯১৩ সরকারী দাবী আদায় আইন, ১৯১৩
                                        সরকারী দাবী আদায় আইন, ১৯১৩</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="h6 text-dark-75">সিস্টেমটির মাধ্যমে আবেদনকারী সার্টিফিকেট অভিযোগ দায়ের  করতে পারবে, আপীল করতে পারবে এবং আপীলের সর্বশেষ অবস্থা সম্পর্কে জানতে পারবে।</div>
                                </div>
                            </div>
                        </div>
                    </div>
