	...
	<div class="priview-body">
		...
		<div class="priview-demand">
	       	...
	       	<table cellspacing="0" cellpadding="0" border="1" width="980px">
                        <thead>
                            <tr>
                                <td valign="middle" width="5%" align="center">ক্রম</td>
                                <td valign="middle" width="15%" align="center"> তারিখ</td>
                                <td valign="middle" width="65%" align="center"> আদেশ </td>
                                <td valign="middle" width="15%" align="center"> স্বাক্ষর</td>
                            </tr>
                        </thead>
                        <?php foreach($appealOrderLists as $key=>$row){?>
                        <tbody>
