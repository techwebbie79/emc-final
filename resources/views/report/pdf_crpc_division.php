		...
		<div class="priview-demand">
            ...
            <!-- <table class="table table-hover table-bordered report">
				...
				<tbody>
					<?php
                    $i=1;
                        foreach($crpc as $crpc)
                        {
                            ?><tr><?php
                            ?><th class="text-center"><?=$i++;?></th><?php
                            ?><th class="text-center"><?=$crpc->crpc_id;?></th><?php
                            ?><th class="text-center"><?=$crpc->crpc_name;?></th><?php
                            ?><tr><?php
                        }
