                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input name="applicant[name]" id="applicantName_1"
                                                                                class="form-control form-control-sm name-group" value="{{ $applicantCitizen->citizen_name ?? ''}}">
                                                                            <input type="hidden" name="applicant[type]"
                                                                                class="form-control form-control-sm" value="1">
                                                                            <input type="hidden" name="applicant[id]"
                                                                                id="applicantId_1" class="form-control form-control-sm" value="{{ $applicantCitizen->id ?? ''}}">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="applicantNid_1"
                                                                                ...
                                                                                পত্র</label>
                                                                            <input name="applicant[nid]" id="applicantNid_1" class="form-control form-control-sm" value="{{ $applicantCitizen->citizen_NID?? '' }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input name="defaulter[name][]"
                                                                                            id="defaulterName_1"
                                                                                            class="form-control form-control-sm"
                                                                                             value="{{ isset($defaulterCitizen->citizen_name) }}">
                                                                                        <input type="hidden"
                                                                                            name="defaulter[type][]"
                                                                                            class="form-control form-control-sm"
                                                                                            value="2">
                                                                                        <input type="hidden"
                                                                                            ...
                                                                                            id="defaulterId_1"
                                                                                            class="form-control form-control-sm"
                                                                                             value="{{ isset($defaulterCitizen->id) }}">
                                                                                        <input type="hidden"
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input name="defaulter[phn][]"
                                                                                            id="defaulterPhn_1"
                                                                                            class="form-control form-control-sm"
                                                                                             value="{{ isset($defaulterCitizen->citizen_phone_no) }}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input name="defaulter[nid][]"
                                                                                            id="defaulterNid_1"
                                                                                            class="form-control form-control-sm"
                                                                                             value="{{ isset($defaulterCitizen->citizen_NID) }}">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input name="defaulter[father][]"
                                                                                            ...
                                                                                            class="form-control form-control-sm"
                                                                                             value="{{ isset($defaulterCitizen->father) }}">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input name="defaulter[mother][]"
                                                                                            ...
                                                                                            class="form-control form-control-sm"
                                                                                             value="{{ isset($defaulterCitizen->mother) }}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
