@extends('layouts.landing._header')
                                    ...
                                    <ul class="nav nav-pills nav-fill">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link px-0" id="regTab2" data-toggle="tab" href="#regTab_2">
                                                ...
                                                <span class="nav-text">বিবাদীর তথ্য</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                                ...
                                                <div class="panel-body">
                                                    <div class="clearfix">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input required type="text" name="defaulter[dob]" placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী)" id="dob" class="form-control common_datepicker" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                ...
                                                <div class="panel-body">
                                                    <div class="clearfix">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input required type="text" name="guarantor[dob]" placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী)" id="dob" class="form-control common_datepicker" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                ...
                                                <div class="panel-body">
                                                    <div class="clearfix">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input required type="text" name="lawyer[dob]" placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী)" id="dob" class="form-control common_datepicker" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="clearfix">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <input required type="text" id="nomineeDob_1" name="nominee[dob][]" placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী)" id="dob" class="form-control common_datepicker" autocomplete="off">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                ...
                                                <div class="panel-body">
                                                    <div class="clearfix">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input required type="text" name="issuer[dob]" placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী)" id="dob" class="form-control common_datepicker" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
