...
<style type="text/css">
    .nav .nav-link .nav-text{font-size: 1.2rem; font-weight: 700;}
</style>
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form id="appealCase" action="{{ route('citizen.appeal.store') }}" class="form" method="POST"
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="example-preview">
                                    <ul class="nav nav-pills nav-fill">
                                        ...
                                        <li class="nav-item" id="tab_victim" style="display: none;">
                                                ...
                                                <div class="panel-body">
                                                    <div class="clearfix">
                                                                    ...
                                                                    <div class="radio">
                                                                        <label class="mr-5">
                                                                            <input type="radio" id="oldCaseRadio"
                                                                                class="is_own_case  mr-2" value="0" checked
                                                                                name="is_own_case">অন্যের মামলা
                                                                        </label>
                                                                        <label>
                                                                            <input type="radio" id="new"
                                                                                class="is_own_case mr-2" value="1"
                                                                                name="is_own_case">নিজের মামলা
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="caseNo" class="control-label">মামলা
                                                                        নম্বর</label>
                                                                    <div name="caseNo" id="caseNo"
                                                                        class="form-control form-control-sm">সিস্টেম কর্তৃক
                                                                        পূরণকৃত </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="lawSection" class="control-label">অভিযোগের ধরণ <span class="text-danger">*</span><span
                                                                            id="link"></span></label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="lawSection" class="control-label">উপজেলা /
                                                                        থানা</label>
                                                                    <!-- <input name="lawSection" id="lawSection" class="form-control form-control-sm"
                                                                                    value="সরকারি পাওনা আদায় আইন, ১৯১৩ এর ৫ ধারা"> -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea id="applicantPresentAddree_1" name="applicant[presentAddress]" rows="1"
                                                                        ...
                                                                        <div class="clearfix">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="defaulterPresentAddree_1"><span
                                                                                                style="color:#FF0000">*
                                                                                            </span>ঠিকানা</label>
                                                                                        <textarea id="defaulterPresentAddree_1" name="defaulter[presentAddress][]" rows="1" class="form-control element-block blank"
                                                                                            aria-describedby="note-error"
                                                                                            aria-invalid="false"></textarea>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="defaulterEmail_1">ইমেইল</label>
                                                                                        <input type="email"
                                                                                            name="defaulter[email][]"
                                                                                            id="defaulterEmail_1"
                                                                                            class="form-control form-control-sm"
                                                                                            value="">
                                                                                    </div>
                                                        ...
                                                        <div class="accordion accordion-solid accordion-toggle-plus"
                                                            ...
                                                            <div id="cloneWitness" class="card">
                                                                ...
                                                                <div class="card-header" id="headingOne3">
                                                                    <div class="card-title h4" data-toggle="collapse"
                                                                        data-target="#collapseOne3">
                                                                        সাক্ষীর তথ্য &nbsp; <span id="spannCount">(1)</span>
                                                                    </div>
                                                                </div>
                                                                <div id="collapseOne3" class="collapse show"
                                                                    data-parent="#accordionExample3">
                                                                    <div class="card-body">
                                                                        <div class="clearfix">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <input name="witness[organization_id][]"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="witnessPresentAddree_1"><span
                                                                                                style="color:#FF0000">*
                                                                                            </span>ঠিকানা</label>
                                                                                        <textarea id="witnessPresentAddree_1" name="witness[presentAddress][]" rows="1" class="form-control element-block blank"
                                                                                            aria-describedby="note-error"
                                                                                            aria-invalid="false"></textarea>
                                                                                    </div>
                                                                                </div>
                        ...
                        <fieldset class=" mb-8">
                            <input type="hidden" name="note" id="note" class="form-control form-control-sm" value="">
                            <div
