                    ...
                    <div class="card phomebutton_card" style="background: #f6f6f7 !important">
                        <div class="card-body phomebutton_cbody">
                            ...
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <a href="{{ route('mobile.first.registration.opt.form',['role_id'=>encrypt(20)]) }}"><button class="btn btn-success btn-block"><i class="fas fa-user"></i> আইনজীবী  নিবন্ধন</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
