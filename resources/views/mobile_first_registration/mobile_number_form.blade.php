                ...
                <div class="col-lg-12 phomebuttons">
                    ...
                    <div class="card " style="background: #f6f6f7 !important">
                        <div class="card-body mt-15">
                            ...
                            <br>
                            <form id="nidVerifyForm" action="{{ route('mobile.first.registration.opt.send') }}" class="form" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile_no" id="mobile_no"
                                                ...
                                                placeholder="মোবাইল নং ইংরেজিতে ১১ অক্ষর" value="{{ old('mobile_no') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="email" class="control-label">{{ $email_field_label }}</label>
