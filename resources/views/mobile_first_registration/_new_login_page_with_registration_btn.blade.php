        ...
        <div class="container" style="margin-top:100px">
            <div class="row">
                ...
                <div class="col-md-6 shadow-sm p-3 mb-5 bg-white rounded">
                    ...
                    <p class="text-dark h4 text-center">স্মার্ট এক্সিকিউটিভ ম্যাজিস্ট্রেট কোর্ট ব্যবস্থায় লগইন করুন</p>
                    ...
                    border-radius:5px ">
                            ...
                            <p class="h4 pt-5 text-dark">স্মার্ট এক্সিকিউটিভ ম্যাজিস্ট্রেট কোর্ট ব্যবস্থায় একাউন্ট নেই? <a href="{{ route('registration') }}">রেজিষ্টেশন করুন </a></p>
                        </div>
                    </form>
                </div>
                <div class="col-md-3"></div>
