                    ...
                    <td>
                        <div class="btn-group float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ route('appeal.getInvestigationOrderSheets', encrypt($row->id)) }}">তদন্তের আদেশ </a>
                                <a class="dropdown-item" href="{{ route('appeal.investigationReport', encrypt($row->id)) }}">তদন্তের রিপোর্ট প্রদান </a>
