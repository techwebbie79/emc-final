...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-inline" method="GET"
                action="{{ route('doptor.user.management.user_list.change.role.search', ['office_id' => encrypt($office_id)]) }}">
                ...
                <tbody>
                    ...
                    @foreach ($list_of_all as $value)
                        <tr>
                            ...
                            <td>
                                @if ($value['role_id'] == 37)
                                    <input type="text" class="form-control" value="জেলা ম্যাজিস্ট্রেট আদালত" readonly>
                                @else
                                    <select name="court_select" class="court_select form-control form-control-sm"
                                        ...
                                        @foreach ($courtlist_district as $courtlist_upazila_single)
                                            ...
                                            @endphp
                                            <option value="{{ $courtlist_upazila_single->id }}" {{ $selected }}
                                                class="dis_court">
    ...
    <script>
        $('select[name="role_select"]').on('change', function() {
            ...
            if (role_id == 37 || role_id == 38 || role_id == 39) {
                $('.upa_court').hide();
            } else {
                $('.upa_court').show();
            }
