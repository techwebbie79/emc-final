    ...
    var _initValidation = function () {
        ...
        const witnessNIDValidators =  {
            validators: {
                function (input) {
                    ...
                    if (value.length !=10 || value.length !=13 || value.length !=16 || value.length !=17) {
                        return {
                            valid: false,
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        fv2.removeField("witness[phn][" + rownewIndex + "]", witnessPhoneValidators)
                            ...
                            .removeField("witness[name][" + rownewIndex + "]", witnessNameValidators)
                            .removeField("witness[father][" + rownewIndex + "]", witnessFatherValidators)
                            .removeField("witness[mother][" + rownewIndex + "]", witnessmotherValidators)
        ...
        document.getElementById("witnessAdd").addEventListener("click", function () {
            ...
            fv2.addField("witness[phn][" + witnessRowIndex + "]", witnessPhoneValidators)
                ...
                .addField("witness[name][" + witnessRowIndex + "]", witnessNameValidators)
                .addField("witness[father][" + witnessRowIndex + "]", witnessFatherValidators)
                .addField("witness[mother][" + witnessRowIndex + "]", witnessmotherValidators)
