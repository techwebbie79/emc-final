...
class SettingController extends Controller
{
    ...
    {
        $data['page_title'] = 'সংক্ষিপ্ত আদেশ জেলা ভিত্তিক এন্ট্রি ফরম';
    ...
    public function shortDecisionDistrict()
    {
        ...
        // dd($data);
        $data['page_title'] = 'সংক্ষিপ্ত আদেশ জেলা ভিত্তিক';
    ...
    */
    ...
    public function shortDecisionDetailsCreate($id)
    {
        ...
        $data['page_title'] = 'সংক্ষিপ্ত আদেশের বিস্তারিত';
        // return $data;
        return view('setting.short_decision_template_create')->with($data);
    }
    ...
    public function shortDecisionDetailsStore(Request $request)
    {
        ...
        return redirect()->route('setting.short-decision')->with('success', 'Short decision data updated successfully');
    }
    ...
    public function crpcSectionsEdit($id)
    {
        $crpc_section = DB::table('crpc_sections')
                            ...
                            ->first();
        $page_title = 'সিআরপিসি সেকশন সংশোধন';
        return view('setting.crpc_section_edit', compact('crpc_section', 'page_title'));
    }
    ...
    public function crpcSectionsUpdate(Request $request, $id = '')
    {
        ...
        return redirect()->route('setting.crpcsection')->with('success', 'Crpc data updated successfully');
    }

    public function crpcSectionsCreate()
    {
        $data['page_title'] = 'সিআরপিসি সেকশন এন্ট্রি ফরম';
        return view('setting.crpcSectionsCreate')->with($data);;
    }
    ...
    public function crpcSectionsSave(Request $request)
    {
        ...
        return redirect()->route('setting.crpcsection')->with('success', 'ধারা সফলভাবে সংরক্ষণ করা হয়েছে');
