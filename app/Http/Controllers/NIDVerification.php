...
class NIDVerification extends Controller
{
    ...
    //     $exit_citizen=DB::table('em_citizens')->where('citizen_NID',$request->nid_number)->where('dob', '=', $dob_in_db)->where('citizen_phone_no', '=', $request->mobile_number)->first();
    ...
    //     $Nid_information = DB::table('dummy_nids')->where('national_id', '=', $request->nid_number)->where('mobile_no', '=', $request->mobile_number)->where('dob', '=', $dob_in_db)->first();
    ...
    //     }
    // }
    // public function citizen_appeal_view_pdf($appeal_id)
    // {
    ...
    //     $html = view('report.pdf_order_sheet')->with($data);

    //     $this->generatePDF($html);
    // }

    // public function citizen_appeal_new_view_pdf($appeal_id)
    // {
    //     $id = decrypt($appeal_id);
    //     $user = globalUserInfo();
    ...
    //     $html = view('report.pdf_case_details')->with($data);
    ...
    //     $this->generatePDF($html);
    // }
    // public function citizen_appeal_new_view_pdf_short_order($appeal_id)
    // {
    //     $data['appealShortOrderLists']=EmCaseShortdecisionTemplates::where('id',$appeal_id)->get();
    //     // return $data['appealShortOrderLists'];
    //     $data['page_title']='সংক্ষিপ্ত আদেশ';

    //     $html = view('report.pdf_case_details_short_order')->with($data);
    ...
    public function nid_verification(Request $request)
    {
        $validation_array = [
            ...
            'mobile_number' => 'NID এর সাথে নিবন্ধিত মোবাইল নং দিতে হবে',
