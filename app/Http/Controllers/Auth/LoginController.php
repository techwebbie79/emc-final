...
class LoginController extends Controller
{
    ...
    public function ndoptor_sso_nothi_issus(Request $request)
    {
        ...
        $data['message2'] = 'আপনার নথির তথ্য সআপনার লগইন সফল হয়েছে। কিন্তু আপনাকে এখনো কোন আদালতে নিযুক্ত করা হয়নি। নিযুক্তি নিশ্চিত করতে  01XXXXXXXXX নাম্বারে যোগাযোগ করুন।';
