    ...
    public function index()
    {
        ...
        if ($roleID == 1) {
           ...
           // $data['total_mouja'] = DB::table('mouja')->count();
            ...
            $appeal = EmAppeal::whereIn('id', $total_case_count_advocate['appeal_id_array'])->limit(10)->get();
            ...
            $data['total_case_running_case_by_em']=EmAppeal::where('case_no', '!=', 'অসম্পূর্ণ মামলা')->where('court_id', '=', globalUserInfo()->court_id)->whereIn('appeal_status', ['ON_TRIAL', 'ON_TRIAL_DM'])->where('em_id',globalUserInfo()->id)->count();
