...
class NDoptorRepositoryAdmin
{
    ...
    public static function Dis_Commissioner_Create($employee_info_from_api, $office_info_from_request, $user_info_from_request, $get_office_basic_info)
    {
        ...
        if (isset($office_id)) {
            ...
            $designation = $user_info_from_request['designation_bng'] . '(জেলা ম্যাজিস্ট্রেট)';
            $password = Hash::make('THIS_IS_N_DOPTOR_USER_wM-zu+93Fh+bvn%T78=j*G62nWH-C');
    ...
    public static function EM_UNO_Office_create($employee_info_from_api, $office_info_from_request, $user_info_from_request, $get_office_basic_info)
    {
    ...
    public static function EM_UNO_Office_update($employee_info_from_api, $office_info_from_request, $user_info_from_request, $get_office_basic_info)
    {
        $upazila_id = null;
        $upa_name_bn = null;
        $upa_name_en = null;
